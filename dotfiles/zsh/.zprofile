...
export PATH="${HOME}/.local/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/Library/TeX/texbin:${PATH}"
...
alias isambardssh='clifton auth --identity ~/.ssh/isambardai_20260122_ed25519 && ssh u6iz.aip2.isambard'
